...
export const BotonIcon = ({ onSubmit, icon: Icon = null, color, titulo, data, activo = null, size }) => {
  const esBooleano = typeof activo === 'boolean'

  return (
    <button onClick={() => onSubmit(data)} className="p-2 transition-colors" title={titulo}>
