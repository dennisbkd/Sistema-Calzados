    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 p-4 sm:p-6">
      <div className="max-w-7xl mx-auto">
            ...
            <div className="flex justify-end">
              <BotonAccion
                ...
                onClick={() => {
                  ...
                  setPromocionActual({
                    nombre: '', descripcion: '', tipo: '', valorDescuento: '', fechaInicio: '', fechaFin: '', alcance: 'GENERAL', referencia: ''
                  });
                  setDialogoAbierto(true);
                }}
              />
        ...
        <FormModal
          ...
          formConfig={{
            defaultValues: promocionActual || { nombre: '', descripcion: '', tipo: '', valorDescuento: '', fechaInicio: '', fechaFin: '', alcance: 'GENERAL', referencia: '' }
          }}
        ...
        >
          {(form) => (
            <>
              ...
              {/* Referencia dinámica según alcance */}
              <form.Field name="referencia" children={(field) => (
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Referencia</label>
                  {form.state.values.alcance === 'PRODUCTO' ? (
                    <select className="w-full border rounded-lg px-3 py-2" value={field.state.value || ''} onChange={(e) => field.handleChange(e.target.value)}>
                  ...
                  ) : form.state.values.alcance === 'CATEGORIA' ? (
                    <select className="w-full border rounded-lg px-3 py-2" value={field.state.value || ''} onChange={(e) => field.handleChange(e.target.value)}>
                    ...
                    <input className="w-full border rounded-lg px-3 py-2" placeholder="Opcional (ej: nombre de temporada)" value={field.state.value || ''} onChange={(e) => field.handleChange(e.target.value)} />
                  )}
                </div>
              )} />
