...
export const SideBar = () => {
  ...
  const [openSubmenus, setOpenSubmenus] = useState({
    ...
    compras: location.pathname.startsWith("/home/compras"),
    inventario: location.pathname.startsWith("/home/nota-salida"),
    ventas: location.pathname.startsWith("/home/ventas") || location.pathname.startsWith("/home/control-caja") || location.pathname.startsWith("/home/promociones"),
    productos: location.pathname.startsWith("/home/productos")
  })
  ...
  const menuItems = [
    ...
    },
    {
      ...
      subItems: [
        ...
        { title: "Control de caja", path: "/home/control-caja", icon: ListChecks },
    ...
    },
    {
      ...
      key: "inventario",
      subItems: [
        { title: "Notas de salida", path: "/home/nota-salida", icon: ListChecks },
      ]
    },
    {
      ...
      subItems: [
        ...
        { title: "Categorias", path: "/home/categorias", icon: Tag },
